class AlderiateLive {
    ...
    constructor() {
         ...
         */
        this.CLIENT_IDS = [
            'p091i3kovsji1vfnriz0qcfxt2y0x9'
        ];
         ...
         * @type {string}
         */
        this.API_URL_STREAM = 'https://api.twitch.tv/kraken/streams/?channel=114318873';

        /**
         * L'URL du stream Twitch.
         * @type {string}
         */
        this.URL_STREAM = 'https://www.twitch.tv/alkalyne92';
    ...
    handleResponse(json) {
        ...
        if (this.isOnline === false && isOnline === true) {
            chrome.notifications.create('alderiate', {
                ...
                title: 'Alkalyne92 est en stream !',
    ...
    prepareNextUpdate () {
      ...
      const timeToWaitBeforeNextUpdate = 10000;
